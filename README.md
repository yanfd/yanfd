...
\> WE SUFFER.<a href="https://custom-icon-badges.demolab.com/badge/-Buy_me_a_coffee-FF5E5B" style="display: block; width: 100%; text-align: right; padding: 5px 20px" >  <button style="padding: 8px 16px; background: darkblue; color: white; border: none;font: bold; border-radius: 4px; cursor: pointer">☕️buy me a coffee? </button> </a>
